...
import { changeAllBillable, filterSelectedTask } from '../../../../redux/project/slice';
  ...
  return (
    <Row className='task'>
      <Col span={12} className='task-unselected' style={{ borderRight: '1px solid black' }} >
        <TaskList type={typeTask.unSelectedTask} taskList={taskList} isBillable={isBillable} handleChange={handleChange} />
      </Col>
      <Col span={11} className='task-selected' offset={1}>
        <TaskList type={typeTask.selectedTask} taskList={selectedtaskList} isBillable={isBillable} handleChange={handleChange} />
      </Col>
    </Row>
  );
}
