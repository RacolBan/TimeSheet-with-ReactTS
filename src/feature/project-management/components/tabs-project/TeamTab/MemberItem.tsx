...
function MemberItem ({ member, type }: Props): JSX.Element {
  const memberLevel = (
    <Typography.Text>
      {member.level === ELevelUser.Intern0 || member.level === ELevelUser.Intern1 || member.level === ELevelUser.Intern2
        ? 'Intern'
        : member.level === ELevelUser.Prefresher
          ? 'Prefresher'
          : member.level === ELevelUser.Fresher0 || member.level === ELevelUser.Fresher1 || member.level === ELevelUser.Fresher2
            ? 'Fresher'
            : member.level === ELevelUser.Junior0 || member.level === ELevelUser.Junior1 || member.level === ELevelUser.Junior2
              ? 'Junior'
              : member.level === ELevelUser.Middle0 || member.level === ELevelUser.Middle1 || member.level === ELevelUser.Middle2
                ? 'Middle'
                : 'Senior'
      }
    </Typography.Text>
