...
import { ICustomerRef } from '../../../../../redux/customer/interface';
  ...
  return (
    <div className='general' >
      ...
      <Row>
        ...
        <Col span={14} className='general-name'>
          <Controller
            name='name'
            control={control}
            render={({ field }) => (
      ...
      <Row>
        ...
        <Col span={8} className='general-code'>
          <Controller
            name='code'
            control={control}
            render={({ field }) => (
      ...
      <Row className='row-date'>
        ...
        <Col span={5} className='general-start'>
          <Controller
            name='timeStart'
            control={control}
            render={({ field }) => (
              <input type='date' className='time' value={field.value ?? ''} style={{
                width: '74%',
        ...
        <Col span={5} className='general-end'>
          <Controller
            name='timeEnd'
            control={control}
            render={({ field }) => (
      ...
      <Row>
        ...
        <Col span={10} className='general-note'>
          <Controller
            name='note'
            control={control}
            render={({ field }) => (
